package oracle.g5.Hotel.Alura.views;
...
import oracle.g5.Hotel.Alura.controladores.ReservaControlador;
import oracle.g5.Hotel.Alura.controladores.huespedesControlador;
...
public class RegistroHuesped extends JFrame {
	...
	private huespedesControlador controlHuesped;
	...
	public RegistroHuesped(int idReserva) {
		...
		this.controlHuesped = new huespedesControlador();
	...
	private void guardarHuespedes() {
		if(txtFechaN.getDate() != null && !txtNombre.equals("") && !txtApellido.equals("")&& !txtTelefono.equals("")) {
			...
			Huespedes huespedes = new Huespedes(txtNombre.getText(), txtApellido.getText(), Date.valueOf(fechaN), txtNacionalidad.getSelectedItem().toString(),txtTelefono.getText(), nReserva);
			System.out.println("si funciona!!");
			this.controlHuesped.guardar(huespedes);
